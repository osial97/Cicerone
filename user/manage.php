  ...
  <body>
    <section class="background-gray-lightest">
      <div class="container">
        ...
        <?php
        $sql="SELECT image,codPartecipazione, nome, cognome, email, partecipazione.stato as stato
        ...
        foreach($data as $row){
              echo'<tbody>
              <tr>
              <th><img  height="50px" width="50px" class="img-circle"  src="data:image/jpeg;base64,'.$row["image"].'" alt="errore" /></th>
              <th>'.$row["nome"].'</th>
              <th>'.$row["cognome"].'</th>
              <th>'.$row["email"].'</th>
